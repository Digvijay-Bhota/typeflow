    ...
    <div className="bg-background dark:bg-background border-border dark:border-border rounded-2xl border p-6">
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
        <div className="flex flex-col">
          <span className="text-muted text-xs uppercase">Correct</span>
        ...
        <div className="flex flex-col">
          <span className="text-muted text-xs uppercase">Incorrect</span>
        ...
        <div className="flex flex-col">
          <span className="text-muted text-xs uppercase">Corrected</span>
        ...
        <div className="flex flex-col">
          <span className="text-muted text-xs uppercase">Uncorrected</span>
      ...
      <div className="text-muted border-border dark:border-border mt-6 flex justify-between border-t pt-4 text-sm">
