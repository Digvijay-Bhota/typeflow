...
describe("EventTrace Security & Zod Validation", () => {
  const getBasePayload = () => ({
    ...
    clientElapsedMs: 60000, integrityToken: "t1",
    metrics: {
      wpm: 50, rawWpm: 50, accuracy: 1, correctChars: 250,
      incorrectChars: 0, totalChars: 250, correctedErrors: 0,
      uncorrectedErrors: 0, consistency: null
    },
    integritySignals: {
